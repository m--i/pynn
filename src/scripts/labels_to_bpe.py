...
if __name__ == '__main__':
    ...
    if args.sentences is not None:
        spm.SentencePieceTrainer.train(input=args.sentences, model_prefix=MODEL_PREFIX, vocab_size=4000, character_coverage=0.9995, model_type='bpe', bos_id=-1, eos_id=-1)
